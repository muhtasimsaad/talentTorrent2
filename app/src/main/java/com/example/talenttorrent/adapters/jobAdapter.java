...
public class jobAdapter extends BaseExpandableListAdapter {
    ...
    public jobAdapter(Context context, List<String> expandableListTitle,
    ...
    public View getGroupView(final int listPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            LayoutInflater layoutInflater = (LayoutInflater) this.context.
                    getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = layoutInflater.inflate(R.layout.jobheader, null);
        }

        final TextView budget=convertView.findViewById(R.id.budget);
        TextView listTitleTextView = (TextView) convertView.findViewById(R.id.header);
        TextView status = (TextView) convertView.findViewById(R.id.status);
        listTitleTextView.setTypeface(null, Typeface.BOLD);

        String[] temp=listTitle.split("<>");
        listTitleTextView.setText(temp[0]);
        budget.setText(temp[1]+"  |  "+temp[2]);
        status.setText(temp[3]);
